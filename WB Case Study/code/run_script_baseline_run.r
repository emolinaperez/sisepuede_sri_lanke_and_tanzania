...
te_all <- subset(te_all, iso_code3%in%c("TZA"))
te_all$source <- NULL
te_all$Year <- NULL
...
dir.output <- r"(C:\Users\edmun\OneDrive\Edmundo-ITESM\3.Proyectos\58. Article 6 United Nations\sisepuede_sri_lanke_and_tanzania\WB Case Study\scaled_results\)" 
